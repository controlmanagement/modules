...
while(1):
	...
	log = str(mjd) + ' ' + str(secofday) + ' ' + str(secofday2) + str(data[2])+ ' ' + str(data[3])+ ' ' + str(data[0]) + ' ' + str(data[1]) + ' ' + str(data[4]) + ' ' + str(data[5]) + ' ' + str(data[6]) + ' ' + str(data[7])+ ' ' + str(data[8]) + ' ' + str(data[9]) + ' ' + str(data[10]) + ' ' + str(data[11]) + ' ' + str(data[12]) + ' ' + str(data[13])
